...
set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS18} [get_ports {n[0]}]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS18} [get_ports {n[1]}]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {n[2]}]
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {n[3]}]
set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33} [get_ports {m[0]}]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {m[1]}]
set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {m[2]}]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {m[3]}]
...
##Pmod Headers
##Pmod Header JA
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports wave_out]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {n_IBUF[0]} {n_IBUF[1]} {n_IBUF[2]} {n_IBUF[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA [get_debug_ports u_ila_0/probe1]
set_property port_width 4 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {m_IBUF[0]} {m_IBUF[1]} {m_IBUF[2]} {m_IBUF[3]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe3 [get_nets [list wave_out_OBUF]]
